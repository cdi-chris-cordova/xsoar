register_module_line('PagerDuty v2', 'start', __line__())
CONSTANT_PACK_VERSION = '1.1.13'
demisto.debug('pack id = PagerDuty, pack version = 1.1.13')
...
SLACK_CONTACT_TYPE = "slack_contact_method"
...
register_module_line('PagerDuty v2', 'end', __line__())
