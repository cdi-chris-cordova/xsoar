...
CONSTANT_PACK_VERSION = '3.0.21'
demisto.debug('pack id = HelloWorld, pack version = 3.0.21')
...
class Client(BaseClient):
    ...
    def translate(self, text: str):
        return self._http_request(method='POST', url_suffix='yoda', data={'text': text}, ok_codes=(200,))
...
Returning 'ok' indicates that the connection to the service is successful.
